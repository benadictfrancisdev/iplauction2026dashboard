...
export function AddPlayerModal({ onAdded }: Props) {
  ...
  const handleSubmit = async () => {
    if (!form.player_name || !form.country || !form.role || !form.base_price) {
    ...
    setForm({
      ...
      bowling_style: '', base_price: '', set_number: '', ipl_caps: '', is_capped: false,
    });
    setOpen(false);
    onAdded();
  };
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            <Button onClick={handleSubmit} className="flex-1">Add Player</Button>
